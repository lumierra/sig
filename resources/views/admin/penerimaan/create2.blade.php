                            ...
                            <div class="card-body">
                                <div class="col-lg-12">
                                    <form action="{{ route('admin.penerimaan.store') }}" method="POST" class="needs-validation" novalidate>
                                        ...
                                        <div class="row">
                                            <div class="col-md-7">
                                                <span class="font-weight-bold">Kode Permintaan</span> : <span class="text-danger text-undeline">{{ $demand->code }}</span>
                                                <input type="hidden" name="code" value="{{ $demand->code }}">
                                            </div><br><br>
                                            <div class="col-md-7">
                                                        ...
                                                        <table class="table table-borderless" id="inputFormRow2">
                                                            ...
                                                            @foreach($demand->detail as $detail)
                                                                <tr>
                                                                    ...
                                                                    <td width="100px">
                                                                        <div class="form-group">
                                                                            <input type="text" value="{{ $detail->jumlah }}" class="form-control" id="jumlah" name="jumlah[]" autocomplete="off">
                                                                        </div>
                                                                    </td>
                                                                    <td width="150px">
                                                                        <div class="form-group">
                                                                    ...
                                                                    <td width="300px">
                                                                        <div class="form-group">
                                                                            <input type="text" value="{{ $detail->keterangan }}" class="form-control" id="keterangan" name="keterangan[]" autocomplete="off" placeholder="Keterangan">
                                                                        </div>
                                                                    </td>
                                                                    <td>
