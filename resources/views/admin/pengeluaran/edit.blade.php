                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class="col-lg-12">
                                    <form action="{{ route('admin.pengeluaran.update', $spend->id) }}" method="POST" class="needs-validation" novalidate>
                                        @csrf
                                        {{ method_field('PUT') }}
                                            ...
                                            <div class="col-md-7">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control custom-select" id="tujuan" name="tujuan" required>
                                                        <option name="dapur" {{ $spend->tujuan == 'Dapur'  ? 'selected' : ''}}>Dapur</option>
                                                        <option name="ruangan" {{ $spend->tujuan == 'Ruangan'  ? 'selected' : ''}}>Ruangan</option>
                                                        <option name="dll" {{ $spend->tujuan == 'Dan lain lain'  ? 'selected' : ''}}>Dan lain-lain</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
