...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <a href="{{ route('admin.pengeluaran.create') }}" class="btn btn-success btn-sm float-right btn-icon-split">
    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-success" id="exampleModalLabel">Detail Pengeluaran</h5>
...
<script type="text/javascript">
    $(function () {
        ...
        $('body').on('click', '.showProduct', function () {
            ...
            $.ajax({
                url: "/admin/pengeluaran/" + product_id + '/' + 'showSpend',
                type: 'GET',
                dataType: 'html',
                data: null,
