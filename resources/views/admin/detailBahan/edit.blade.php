...
@section('title', 'Edit Detail Bahan Makanan')

@section('subtitle', 'Edit Detail Bahan Makanan')
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class="col-lg-12">
                                    <form action="{{ route('admin.detail-makanan.update', $food->id) }}" method="POST" class="needs-validation" novalidate>
                                        @csrf
                                        {{ method_field('PUT') }}
                                        ...
                                        <div class="row">
                                            <div class="col-md-7">
                                                <div class="form-group">
                                                    ...
                                                    <input disabled class="form-control" value="{{ ucfirst($food->type->name) }}">
                                                </div>
                                            </div>
                                            <div class="col-md-7">
                                                <div class="form-group">
                                                    <label for="makanan">Nama Makanan</label>
                                                    <input disabled class="form-control" value="{{ ucfirst($food->name) }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div id="inputFormRow">
