            ...
            <div class="modal-body">
                <form id="productForm" name="productForm" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="name" class="col-sm-5 control-label">Nama Ruangan</label>
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="name" name="name" placeholder="Ruangan" value="" maxlength="50" required="" autocomplete="off">
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="description" class="col-sm-5 control-label">Keterangan</label>
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="description" name="description" placeholder="Keterangan" value="" maxlength="50" required="" autocomplete="off">
                        </div>
                    </div>
...
<script type="text/javascript">
    $(function () {
        ...
        $('#createNewProduct').click(function () {
            ...
            $('#modelHeading').html("Form Ruangan");
            $('#ajaxModel').modal('show');
        });

        $('body').on('click', '.editProduct', function () {
            var product_id = $(this).data('id');
            $.get("{{ route('admin.room.index') }}" +'/' + product_id +'/edit', function (data) {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        $.ajax({
                            type: "DELETE",
                            url: "{{ route('admin.room.store') }}"+'/'+product_id,
                            success: function (data) {
                                table.draw();
                            },
                            error: function (data) {
